      ...
      children: [
        {
          path: '/first',
          name: 'project1',
          component: () => import('@/views/pages/Project1.vue')
        },
        {
          path: '/model',
          name: 'model',
        ...
        },
        {
          path: '/vue-bootstrap',
          name: 'vue-bootstrap',
          component: () => import('@/views/pages/vue-bootstrap/VueBootstrap.vue'),
          children: [
            {
              path: 'alert',
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vue-bootstrap/ButtonGroup.vue')
            },
            {
              path: 'button-toolbar',
              name: 'vue-bootstrap-button-toolbar',
              component: () => import('@/views/pages/vue-bootstrap/ButtonToolbar.vue')
            },
            {
              path: 'card',
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vue-bootstrap/Carousel.vue')
            },
            {
              path: 'collapse',
              name: 'vue-bootstrap-collapse',
              component: () => import('@/views/pages/vue-bootstrap/Collapse.vue')
            },
            {
              path: 'dropdown',
              name: 'vue-bootstrap-dropdown',
              component: () => import('@/views/pages/vue-bootstrap/Dropdown.vue')
            },
            {
              path: 'embed',
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vue-bootstrap/FormCheckbox.vue')
            },
            {
              path: 'form-file',
              name: 'vue-bootstrap-form-file',
              component: () => import('@/views/pages/vue-bootstrap/FormFile.vue')
            },
            {
              path: 'form-group',
              name: 'vue-bootstrap-form-group',
              component: () => import('@/views/pages/vue-bootstrap/FormGroup.vue')
            },
            {
              path: 'form-input',
              name: 'vue-bootstrap-form-input',
              component: () => import('@/views/pages/vue-bootstrap/FormInput.vue')
            },
            {
              path: 'form-radio',
              name: 'vue-bootstrap-form-radio',
              component: () => import('@/views/pages/vue-bootstrap/FormRadio.vue')
            },
            {
              path: 'form-select',
              name: 'vue-bootstrap-form-select',
              component: () => import('@/views/pages/vue-bootstrap/FormSelect.vue')
            },
            {
              path: 'form-textarea',
              name: 'vue-bootstrap-form-textarea',
              component: () => import('@/views/pages/vue-bootstrap/FormTextarea.vue')
            },
            {
              path: 'image',
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vue-bootstrap/InputGroup.vue')
            },
            {
              path: 'jumbotron',
              name: 'vue-bootstrap-jumbotron',
              component: () => import('@/views/pages/vue-bootstrap/Jumbotron.vue')
            },
            {
              path: 'layout-grid-system',
              name: 'vue-bootstrap-layout-grid-system',
              component: () => import('@/views/pages/vue-bootstrap/LayoutGridSystem.vue')
            },
            {
              path: 'link',
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vue-bootstrap/ListGroup.vue')
            },
            {
              path: 'media',
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vue-bootstrap/Pagination.vue')
            },
            {
              path: 'pagination-nav',
              name: 'vue-bootstrap-pagination-nav',
              component: () => import('@/views/pages/vue-bootstrap/PaginationNav.vue')
            },
            {
              path: 'popover',
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vue-bootstrap/Progress.vue')
            },
            {
              path: 'spinner',
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vuetify/forms/Autocompletes.vue')
            },
            {
              path: 'file-inputs',
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vuetify/forms/SelectionControls.vue')
            },
            {
              path: 'selects',
            ...
            },
            {
              ...
              component: () => import('@/views/pages/vuetify/tables/SimpleTables.vue')
            },
            {
              path: 'data-tables',
