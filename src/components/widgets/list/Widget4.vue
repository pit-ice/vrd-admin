    ...
    <div class="card-body pt-2">
      <template v-for="(item, i) in list">
        ...
        <div class="d-flex align-items-center mb-10" v-bind:key="i">
          <!--begin::Bullet-->
          <span class="bullet bullet-bar align-self-stretch" v-bind:class="`bg-${item.style}`"></span>
          <!--end::Bullet-->
          <!--begin::Checkbox-->
          <label class="checkbox checkbox-lg checkbox-single flex-shrink-0 m-0 mx-4" v-bind:class="`checkbox-light-${item.style}`">
