  ...
  <div class="card card-custom gutter-b">
    ...
    <div class="card-body d-flex flex-column">
      <div>
        ...
        <div v-html="description" class="text-center font-weight-bolder font-size-lg p-5 pre-formatted"></div>
        <div class="w-100 text-center">
          <router-link to="/data/upload" v-slot="{ href }">
            <a :href="href" class="btn btn-primary btn-shadow-hover font-weight-bolder py-3 px-7 m-1">{{ btnText }}</a>
          </router-link>
          <router-link to="/data/mng" v-slot="{ href }">
            <a :href="href" class="btn btn-primary btn-shadow-hover font-weight-bolder py-3 px-7 m-1">{{ btnText2 }}</a>
          </router-link>
        </div>
      </div>
    </div>
