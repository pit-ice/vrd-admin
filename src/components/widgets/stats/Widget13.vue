<template>
  ...
  <div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 pt-5">
      <h3 class="card-title font-weight-bolder">학습 현황</h3>
    ...
    <div class="card-body d-flex flex-column">
      ...
      <div class="pt-5">
        <p class="text-center font-weight-normal font-size-lg pb-7">
          Notes : 학습이 완료되면, 학습 결과 조회 후 모델 배포를 진행할 수 있습니다.
        </p>
        <a href="#" class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">학습현황 바로가기</a>
      </div>
    </div>
    <!--end::Body-->
  </div>
