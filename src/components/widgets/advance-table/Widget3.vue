            ...
            <tbody>
              <template v-for="(item, i) in list">
                <tr v-bind:key="i">
                  ...
                  <td>
                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ item.paid }}</span>
                    <span class="text-muted font-weight-bold">{{ item.status }}</span>
                  </td>
                  <td>
                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ item.amount }}</span>
                    <span class="text-muted font-weight-bold">{{ item.status2 }}</span>
                  </td>
                  <td>
                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ item.company }}</span>
                    <span class="text-muted font-weight-bold">{{ item.company_desc }}</span>
                  </td>
                  <td>
                    <img src="media/logos/stars.png" alt="image" style="width: 5rem" />
                    <span class="text-muted font-weight-bold d-block">{{ item.rate }}</span>
                  </td>
