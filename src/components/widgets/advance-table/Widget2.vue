    ...
    <div class="card-header border-0 pt-5">
      ...
      <div class="card-toolbar">
        <ul class="nav nav-pills nav-pills-sm nav-dark-75">
          <li class="nav-item">
            <a class="nav-link py-2 px-4 active" data-toggle="tab" href="#kt_tab_pane_1_1">
              Month
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link py-2 px-4" data-toggle="tab" href="#kt_tab_pane_1_2">
              Week
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link py-2 px-4" data-toggle="tab" href="#kt_tab_pane_1_3">
              Day
            </a>
          </li>
        </ul>
          ...
          <tbody>
            <template v-for="(item, i) in list">
              <tr v-bind:key="i">
                <td class="pl-0 py-4">
                  <div class="symbol symbol-50 symbol-light mr-1">
                    <span class="symbol-label">
                      <img :src="item.text0" class="h-50 align-self-center" alt="" />
                    </span>
                  </div>
                </td>
                <td class="pl-0">
                ...
                <td class="text-right">
                  <span class="label label-lg label-inline" v-bind:class="`label-light-${item.text6}`">
                    {{ item.text5 }}
                  </span>
                </td>
