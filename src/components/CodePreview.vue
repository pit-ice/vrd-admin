  ...
  <KTCard ref="preview" v-bind:title="title" v-bind:example="true">
    ...
    <template v-slot:body>
      ...
      <div class="example-code mb-5">
        <ul class="example-nav nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-2x" role="tablist" v-if="!hasGeneralCode && !hasSingleCodeType">
          ...
          <li class="nav-item" v-if="hasJsCode">
            <a class="nav-link" v-on:click="setActiveTab" data-tab="1" data-toggle="tab" href="#" role="tab" aria-selected="false">
              &nbsp;JS&nbsp;
            </a>
          </li>
          <li class="nav-item" v-if="hasScssCode">
            <a class="nav-link" v-on:click="setActiveTab" data-tab="2" data-toggle="tab" href="#" role="tab" aria-selected="false">
              SCSS
            </a>
          </li>
        </ul>
...
<script>
import KTCard from '@/components/Card.vue';
