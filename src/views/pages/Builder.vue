  ...
  <div>
    ...
    <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
      ...
      <div class="alert-text">
        <p>
          The layout builder helps to configure the layout with preferred options and preview it in real time. The configured layout options will be
          saved until you change or reset them. To use the layout builder choose the layout options and click the
        ...
        <p>
          ...
          Some pages from the <code>html</code> version might not exist in the <code>vue</code>. But the CSS styles from <code>html</code> version
          already integrated into the <code>vue</code>. All the components from the <code>html</code> version are static and non-working components.
          You can copy the component HTML from the <code>html</code> version, and paste it in the <code>vue</code> component to get the same style.
          The actual functionality and implementation need to be done by the customer because every application has its own business requirements.
        </p>
      </div>
    </div>
    <!--end::Notice-->
    ...
    <div class="card card-custom gutter-b">
      <div class="card-header card-header-tabs-line">
        <ul class="nav nav-dark nav-bold nav-tabs nav-tabs-line" role="tablist" ref="builder-tab">
          ...
          <li class="nav-item">
            <a class="nav-link" v-on:click="setActiveTab" data-tab="1" data-toggle="tab" href="#" role="tab">
              Header
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" v-on:click="setActiveTab" data-tab="2" data-toggle="tab" href="#" role="tab">
              Subheader
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" v-on:click="setActiveTab" data-tab="3" data-toggle="tab" href="#" role="tab">
              Content
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" v-on:click="setActiveTab" data-tab="4" data-toggle="tab" href="#" role="tab">
              Aside
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" v-on:click="setActiveTab" data-tab="5" data-toggle="tab" href="#" role="tab">
              Footer
            </a>
          </li>
        </ul>
...
export default {
  ...
  methods: {
    ...
    setActivePreviousTab() {
      ...
      this.$refs['builder-tab'].querySelector(`[data-tab="${this.tabIndex}"]`).classList.add('active');
    },
    /**
