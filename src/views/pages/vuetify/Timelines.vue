  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Timelines</b> The <code>v-timeline</code> is useful for stylistically displaying chronological information.
        <a class="font-weight-bold" href="https://vuetifyjs.com/en/components/timelines" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
      ...
      <div class="col-md-12">
        <KTCodePreview v-bind:title="'Small dots'">
          <template v-slot:preview>
            <p>The <code>small</code> prop allows alternate styles to provide a unique design.</p>
              ...
              <v-timeline-item color="purple lighten-2" fill-dot right>
                <v-card>
                  ...
                  <v-container>
                    <v-row>
                      <v-col cols="12" md="10">
                        Lorem ipsum dolor sit amet, no nam oblique veritus. Commune scaevola imperdiet nec ut, sed euismod convenire principes at. Est
                ...
                <v-card>
                  ...
                  <v-container>
                    <v-row>
                      <v-col>
                        Lorem ipsum dolor sit amet, no nam oblique veritus. Commune scaevola imperdiet nec ut, sed euismod convenire principes at. Est
                        et nobis iisque percipit, an vim zril disputando voluptatibus, vix an salutandi sententiae.
                      </v-col>
                    </v-row>
                  </v-container>
                </v-card>
        ...
        <KTCodePreview v-bind:title="'Icon dots'">
          <template v-slot:preview>
            ...
            <v-timeline align-top :dense="$vuetify.breakpoint.smAndDown">
              <v-timeline-item v-for="(item, i) in code2.items" :key="i" :color="item.color" :icon="item.icon" fill-dot>
        ...
        <KTCodePreview v-bind:title="'Avatar dots'">
          <template v-slot:preview>
            <p>Insert avatars into dots with use of the <code>icon</code> slot and <code>v-avatar</code>.</p>
            <v-timeline>
              <v-timeline-item v-for="n in 4" :key="n" large>
                ...
                <v-card class="elevation-2">
                  ...
                  <v-card-text
                    >Lorem ipsum dolor sit amet, no nam oblique veritus. Commune scaevola imperdiet nec ut, sed euismod convenire principes at. Est et
                    nobis iisque percipit, an vim zril disputando voluptatibus, vix an salutandi sententiae.</v-card-text
                  >
                </v-card>
              </v-timeline-item>
            </v-timeline>
      ...
      <div class="row">
            ...
            <template v-slot:preview>
              ...
              <v-card class="mx-auto" max-width="400">
                <v-card dark flat>
                  ...
                  <v-img src="media/stock-600x600/img-10.jpg" gradient="to top, rgba(0,0,0,.44), rgba(0,0,0,.44)">
        ...
        <div class="col-md-6">
          <KTCodePreview v-bind:title="'Dense alert'">
            <template v-slot:preview>
              <p>
                <code>dense</code> timelines position all content to the right. In this example, <code>v-alert</code> replaces the card to provide a
                different design.
              </p>
...
<v-card class="elevation-2">
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vuetify', route: 'alerts' }, { title: 'Timelines' }]);
  },
