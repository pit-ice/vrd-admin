  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Selection controls</b> Selection control components allow a user to select options. These components <strong>must</strong> be used with the
        <code>v-model</code> prop as they do not maintain their own state.
        <a class="font-weight-bold" href="https://vuetifyjs.com/en/components/selection-controls" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Radios - Colors'">
          <template v-slot:preview>
            <p>Radios can be colored by using any of the builtin colors and contextual names using the <code>color</code> prop.</p>
            <v-card flat>
              <v-card-text>
                <v-container fluid>
                  <v-row>
                ...
                <v-container fluid>
                  <v-row>
                    <v-col cols="12" sm="4" md="4">
                      <v-switch v-model="code8.ex11" label="red" color="red" value="red" hide-details></v-switch>
                      <v-switch v-model="code8.ex11" label="red darken-3" color="red darken-3" value="red darken-3" hide-details></v-switch>
                    </v-col>
                    <v-col cols="12" sm="4" md="4">
                      <v-switch v-model="code8.ex11" label="indigo" color="indigo" value="indigo" hide-details></v-switch>
                      <v-switch v-model="code8.ex11" label="indigo darken-3" color="indigo darken-3" value="indigo darken-3" hide-details></v-switch>
                    </v-col>
                    <v-col cols="12" sm="4" md="4">
                      <v-switch v-model="code8.ex11" label="orange" color="orange" value="orange" hide-details></v-switch>
                      <v-switch v-model="code8.ex11" label="orange darken-3" color="orange darken-3" value="orange darken-3" hide-details></v-switch>
                    </v-col>
                  </v-row>

                  <v-row class="mt-12">
                    <v-col cols="12" sm="4" md="4">
                      <v-switch v-model="code8.ex11" label="primary" color="primary" value="primary" hide-details></v-switch>
                      <v-switch v-model="code8.ex11" label="secondary" color="secondary" value="secondary" hide-details></v-switch>
                    </v-col>
                    <v-col cols="12" sm="4" md="4">
                      <v-switch v-model="code8.ex11" label="success" color="success" value="success" hide-details></v-switch>
                      <v-switch v-model="code8.ex11" label="info" color="info" value="info" hide-details></v-switch>
                    </v-col>
                    <v-col cols="12" sm="4" md="4">
                      <v-switch v-model="code8.ex11" label="warning" color="warning" value="warning" hide-details></v-switch>
                      <v-switch v-model="code8.ex11" label="error" color="error" value="error" hide-details></v-switch>
                    </v-col>
                  </v-row>
                </v-container>
              </v-card-text>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Checkboxes - Array'">
          <template v-slot:preview>
            <v-container fluid>
              <p>{{ code2.selected }}</p>
              <v-checkbox v-model="code2.selected" label="John" value="John"></v-checkbox>
              <v-checkbox v-model="code2.selected" label="Jacob" value="Jacob"></v-checkbox>
            </v-container>
          </template>
          <template v-slot:html>
            {{ code2.html }}
        ...
        <KTCodePreview v-bind:title="'Switches - Boolean'">
          <template v-slot:preview>
            <v-container fluid>
              <v-switch v-model="code4.switch1" :label="`Switch 1: ${code4.switch1.toString()}`"></v-switch>
              <v-switch v-model="code4.switch2" :label="`Switch 2: ${code4.switch2.toString()}`"></v-switch>
            </v-container>
          </template>
          <template v-slot:html>
            {{ code4.html }}
            ...
            <v-container fluid>
              ...
              <v-switch v-model="code7.switchMe">
                <template v-slot:label>
                  ...
                  <v-progress-circular :indeterminate="code7.switchMe" :value="0" size="24" class="ml-2"></v-progress-circular>
                </template>
              </v-switch>
            </v-container>
          </template>
