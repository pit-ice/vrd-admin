  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>File inputs</b> The <code>v-file-input</code> component is a specialized input that provides a clean interface for selecting files, showing
        detailed selection information and upload progress. It is meant to be a direct replacement for a standard file input.
        <a class="font-weight-bold" href="https://vuetifyjs.com/en/components/file-inputs" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Multiple'">
          <template v-slot:preview>
            <p>The <code>v-file-input</code> can contain multiple files at the same time when using the <strong>multiple</strong> prop.</p>
        ...
        <KTCodePreview v-bind:title="'Custom icons'">
          <template v-slot:preview>
            <p>The <code>v-file-input</code> has a default prepended icon that can be set on the component or adjusted globally.</p>
        ...
        <KTCodePreview v-bind:title="'Complex selection slots'">
          <template v-slot:preview>
            <p>
              The flexibility of the selection slot allows you accomodate complex use-cases. In this example we show the first 2 selections as chips
              while adding a number indicator for the remaining amount.
            </p>
            <v-file-input
              v-model="code7.files"
            ...
            >
              <template v-slot:selection="{ index, text }">
                ...
                <span v-else-if="index === 2" class="overline grey--text text--darken-3 mx-2"> +{{ code7.files.length - 2 }} File(s) </span>
              </template>
            </v-file-input>
          </template>
          <template v-slot:html>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'With chips'">
          <template v-slot:preview>
            <p>
              A selected file can be displayed as a chip. When using the chips and multiple props, each chip will be displayed (as opposed to the file
              count).
            </p>
            <div>
        ...
        <KTCodePreview v-bind:title="'Size displaying'">
          <template v-slot:preview>
            <p>
              The displayed size of the selected file(s) can be configured with the show-size property. Display sizes can be either 1024 (the default
              used when providing true) or 1000.
            </p>
