  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Buttons</b> The <code>v-btn</code> component replaces the standard html button with a material design theme and a multitude of options. Any
        color helper class can be used to alter the background or text color.
        <a class="font-weight-bold" href="https://vuetifyjs.com/en/components/buttons" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
            ...
            <v-container id="dropdown-example">
              <v-row>
                <v-col cols="12" sm="4">
                  ...
                  <v-overflow-btn class="my-2" :items="code3.dropdown_font" label="Overflow Btn" target="#dropdown-example"></v-overflow-btn>
                </v-col>
                ...
                <v-col cols="12" sm="4">
                  ...
                  <v-overflow-btn class="my-2" :items="code3.dropdown_edit" label="Editable Btn" editable item-value="text"></v-overflow-btn>
                </v-col>
              </v-row>
            </v-container>
          </template>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vuetify', route: 'alerts' }, { title: 'Buttons' }]);
  },
  watch: {
    loader() {
      const l = this.loader;
