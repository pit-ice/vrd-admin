  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Avatars</b> The v-avatar component is typically used to display circular user profile pictures. This component will allow you to
        dynamically size and add a border radius of responsive images, icons, and text. A tile variation is available for displaying an avatar without
        border radius.
        <a class="font-weight-bold" href="https://vuetifyjs.com/en/components/avatars" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Size'">
          <template v-slot:preview>
            <p>
              The <code>size</code> prop allows you to define the height and width of <code>v-avatar</code>. This prop scales both evenly with an
              aspect ratio of 1. <code>height</code> and <code>width</code> props will override this prop.
            </p>
        ...
        <KTCodePreview v-bind:title="'Profile Card'">
          <template v-slot:preview>
            <p>Using the <code>tile</code> prop, we can create a sleek hard-lined profile card.</p>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Default slot'">
          <template v-slot:preview>
            <p>
              The <code>v-avatar</code> default slot will accept the <code>v-icon</code> component, an image, or text. Mix and match these with other
              props to create something unique.
            </p>
            <v-row justify="space-around">
            ...
            <v-container fluid>
              <v-row justify="center">
                ...
                <v-expansion-panels popout>
                  <v-expansion-panel v-for="(message, i) in code4.messages" :key="i" hide-actions>
...
>
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vuetify', route: 'alerts' }, { title: 'Avatars' }]);
  }
};
</script>
