  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Tooltips</b> The <code>v-tooltip</code> component is useful for conveying information when a user hovers over an element. You can also
        programmatically control the display of tooltips through a <code>v-model</code>. When activated, tooltips display a text label identifying an
        element, such as a description of its function.
        <a class="font-weight-bold" href="https://vuetifyjs.com/en/components/tooltips" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
            ...
            <div class="text-center">
              <v-tooltip left>
                <template v-slot:activator="{ on }">
                  <v-btn class="mr-4" color="primary" dark v-on="on">Left</v-btn>
                </template>
              ...
              <v-tooltip bottom>
                <template v-slot:activator="{ on }">
                  <v-btn class="mr-4" color="primary" dark v-on="on">Bottom</v-btn>
                </template>
              ...
              <v-tooltip right>
                <template v-slot:activator="{ on }">
                  <v-btn class="mr-4" color="primary" dark v-on="on">Right</v-btn>
                </template>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vuetify', route: 'alerts' }, { title: 'Tooltips' }]);
  }
};
</script>
