  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Badges</b> The <code>v-badge</code> component superscripts or subscripts an avatar-like icon or text onto content to highlight information
        to a user or to just draw attention to a specific element. Content within the badge usually contains numbers or icons.
        <a class="font-weight-bold" href="https://vuetifyjs.com/en/components/badges" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
          ...
          <template v-slot:preview>
            ...
            <v-container>
              <v-row justify="space-around">
                ...
                <v-badge :content="code3.messages" :value="code3.messages" color="green" overlap>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Show-on-hover'">
          <template v-slot:preview>
            ...
            <div class="text-center">
              <v-badge :value="code2.hover" color="deep-purple accent-4" content="9999+" left transition="slide-x-transition">
        ...
        <KTCodePreview v-bind:title="'Customization options'">
          <template v-slot:preview>
            <p>
              The <code>v-badge</code> component is flexible and can be used in a variety of use-cases over numerous elements. Options to tweak the
              location are also available through the offset-x and offset-y props.
            </p>
            <v-container>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vuetify', route: 'alerts' }, { title: 'Badges' }]);
  }
};
</script>
