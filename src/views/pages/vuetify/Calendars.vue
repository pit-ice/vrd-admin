  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Calendars</b> The <code>v-calendar</code> component is used to display information in a daily, weekly, or monthly view. The daily view has
        slots for all day or timed elements, and the weekly and monthly view has a slot for each day. Optionally you can pass in an array of events
        and they will be rendered over the appropriate days and times.
        <a class="font-weight-bold" href="https://vuetifyjs.com/en/components/calendars" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
      ...
      <div class="col-md-12">
        <KTCodePreview v-bind:title="'Weekly'">
          <template v-slot:preview>
            <p>This is an example of an event calendar with all-day and timed events with a type of <code>week</code>.</p>
            <v-row>
              <v-col>
                <v-sheet height="400">
                  <v-calendar ref="calendar" :now="code1.today" :value="code1.today" :events="code1.events" color="primary" type="week"></v-calendar>
                </v-sheet>
              </v-col>
            </v-row>
          </template>
    ...
    <div class="row">
      <div class="col-md-12">
        <KTCodePreview v-bind:title="'Daily'">
          <template v-slot:preview>
            <p>This is an example of calendar with content in each interval slot and a type of <code>day</code>.</p>
            <v-row>
              <v-col>
                <v-sheet height="400">
        ...
        <KTCodePreview v-bind:title="'Slots'">
          <template v-slot:preview>
            ...
            <v-row>
              <v-col>
                <v-sheet height="500">
                  <v-calendar :now="code3.today" :value="code3.today" color="primary">
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vuetify', route: 'alerts' }, { title: 'Calendars' }]);
