  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        ...
        <a class="font-weight-bold" href="https://github.com/fengyuanchen/cropperjs" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <div class="img-cropper">
              <vue-cropper ref="cropper" :src="imgSrc" preview=".preview" class="cropper-min-height" />
            </div>
            <div class="actions">
