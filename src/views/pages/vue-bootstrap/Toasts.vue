  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Toasts</b> Push notifications to your visitors with a &lt;b-toast&gt; and &lt;b-toaster&gt;, lightweight components which are easily
        customizable for generating alert messages.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/toast" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-12">
        <KTCodePreview v-bind:title="'Toasts'">
          <template v-slot:preview>
            <p>
              ...
              <code>backdrop-filter</code> CSS property, they also attempt to blur the elements under the toast.
            </p>
        ...
        <KTCodePreview v-bind:title="'Toasts on demand'">
          <template v-slot:preview>
            <p>
              ...
              <code>this.$bvToast</code> Vue component instance injection, without the need to place a <code>&lt;b-toast&gt;</code> component in your
              app.
            </p>
            <div>
        ...
        <KTCodePreview v-bind:title="'Variants'">
          <template v-slot:preview>
            <p>
              BootstrapVue toasts provide custom CSS to define color variants. Variants follow the standard Bootstrap v4 variant names. If you have
              custom SCSS defined Bootstrap color theme variants, the toast custom SCSS will automatically create toast variants for you (refer to the
              <a href="https://bootstrap-vue.js.org/docs/reference/theming" target="_blank">
                Theming
              </a>
              reference section).
            </p>
            <div>
              ...
              <b-button variant="primary" @click="makeToastVariant('primary')" class="mb-2 mr-3">
                Primary
              </b-button>
              <b-button variant="secondary" @click="makeToastVariant('secondary')" class="mb-2 mr-3">
                Secondary
              </b-button>
              <b-button variant="danger" @click="makeToastVariant('danger')" class="mb-2 mr-3">
                Danger
              </b-button>
              <b-button variant="warning" @click="makeToastVariant('warning')" class="mb-2 mr-3">
                Warning
              </b-button>
              <b-button variant="success" @click="makeToastVariant('success')" class="mb-2 mr-3">
                Success
              </b-button>
              <b-button variant="info" @click="makeToastVariant('info')" class="mb-2">
                Info
              </b-button>
            </div>
          </template>
        ...
        <KTCodePreview v-bind:title="'Toaster target'">
          <template v-slot:preview>
            <p>
              The below toasters place the toasts in a stacked (columnar format), fixed within the viewport (meaning they will always be in view
              regardless of viewport scroll position). If there are more toasts than can fit on the viewport screen, some will be visually hidden
              offscreen until other toasts are closed/hidden.
            </p>
            <div>
              ...
              <b-button @click="toast('b-toaster-bottom-right', true)" class="mb-2 mr-3">
                b-toaster-bottom-right
              </b-button>
              <b-button @click="toast('b-toaster-bottom-left', true)" class="mb-2 mr-3">
                b-toaster-bottom-left
              </b-button>
              <b-button @click="toast('b-toaster-bottom-center', true)" class="mb-2 mr-3">
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Notify', route: 'popover' }, { title: 'Toasts' }]);
  }
};
</script>
