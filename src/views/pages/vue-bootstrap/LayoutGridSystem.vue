  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Layout and Grid System</b> Use the powerful mobile-first flexbox grid (via the &lt;b-container&gt;, &lt;b-row&gt;, &lt;b-form-row&gt; and
        &lt;b-col&gt; components) to build layouts of all shapes and sizes thanks to a twelve column system, five default responsive tiers, CSS Sass
        variables and mixins, and dozens of predefined classes.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/layout" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Variable width content'">
          <template v-slot:preview>
            <p>Use <code>{breakpoint}="auto"</code> props to size columns based on the natural width of their content.</p>
            <b-container class="bv-example-row">
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'All breakpoints'">
          <template v-slot:preview>
            <p>
              For grids that are the same from the smallest of devices to the largest, use the <code>col</code> and <code>cols="*"</code> props.
              Specify a number of <code>cols</code> when you need a particularly sized column; otherwise, feel free to stick to
              <code>col</code> (which is applied automatically if no <code>cols</code> are specified).
            </p>
            <b-container class="bv-example-row">
              <b-row>
                <b-col>col</b-col>
        ...
        <KTCodePreview v-bind:title="'Stacked to horizontal'">
          <template v-slot:preview>
            <p>
              Using a single set of <code>sm="*"</code> or <code>sm</code> (boolean for equal width @sm) props, you can create a basic grid system
              that starts out stacked on extra small devices before becoming horizontal on desktop (medium) devices
            </p>
            <b-container class="bv-example-row">
              <b-row>
        ...
        <KTCodePreview v-bind:title="'Mix and match'">
          <template v-slot:preview>
            <p>
              Don't want your columns to simply stack in some grid tiers? Use a combination of different props for each tier as needed. See the
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Layout and Grid System' }]);
  }
};
</script>
