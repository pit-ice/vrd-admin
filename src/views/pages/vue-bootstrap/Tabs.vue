  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Tabs</b> Create a widget of tabbable panes of local content. The tabs component is built upon navs and cards internally, and provides full
        keyboard navigation control of the tabs.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/tabs" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Pills variant'">
          <template v-slot:preview>
            <p>
              Tabs use the <code>tabs</code> styling by default. Just add <code>pills</code> property to <code>&lt;b-tabs&gt;</code> for the pill
              style variant.
            </p>
            <div>
              <b-card no-body>
        ...
        <KTCodePreview v-bind:title="'Fill'">
          <template v-slot:preview>
            <p>
              To proportionately fill all available space with your tab controls, set the <code>fill</code> prop. Notice that all horizontal space is
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Justified'">
          <template v-slot:preview>
            <p>
              For equal-width controls, use the <code>justified</code> prop instead. All horizontal space will be occupied by the controls, but unlike
              using <code>fill</code> above, every control will be the same width.
            </p>
            <div>
        ...
        <KTCodePreview v-bind:title="'Vertical tabs'">
          <template v-slot:preview>
            <p>
              ...
              <code>vertical</code> prop to <code>true</code>. Vertical tabs work with or without <code>card</code> mode enabled.
            </p>
            <div>
              <b-card no-body>
        ...
        <KTCodePreview v-bind:title="'Add custom content to tab title'">
          <template v-slot:preview>
            <p>
              ...
              <code>title</code> slot of <code>&lt;b-tab&gt;</code>
            </p>
            <div>
              <b-tabs>
                <b-tab active>
                ...
                <b-tab>
                  <template v-slot:title> <b-spinner type="border" small></b-spinner> Tab 2 </template>
      ...
      <div class="col-md-12">
        <KTCodePreview v-bind:title="'Cards integration'">
          <template v-slot:preview>
            <p>
              Tabs support integrating with Bootstrap cards. Just add the card property to <code>&lt;b-tabs&gt;</code> and place it inside a
              <code>&lt;b-card&gt;</code> component. Note that you should add the <code>no-body</code> prop on the
              <code>&lt;b-card&gt;</code> component in order to properly decorate the card header and remove the extra padding introduced by
              <code>card-body</code>.
            </p>
            <div>
              <b-card no-body>
                <b-tabs card>
                  ...
                  <b-tab title="Text">
                    ...
                    <b-card-text>
                      Quis magna Lorem anim amet ipsum do mollit sit cillum voluptate ex nulla tempor. Laborum consequat non elit enim exercitation
                      cillum aliqua consequat id aliqua. Esse ex consectetur mollit voluptate est in duis laboris ad sit ipsum anim Lorem. Incididunt
                      veniam velit elit elit veniam Lorem aliqua quis ullamco deserunt sit enim elit aliqua esse irure.
                    </b-card-text>
                  </b-tab>
                </b-tabs>
              </b-card>
