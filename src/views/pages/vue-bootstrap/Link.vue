  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Links</b> Use BootstrapVue's custom b-link component for generating a standard &lt;a&gt; link or &lt;router-link&gt;. &lt;b-link&gt;
        supports the disabled state and click event propagation.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/link" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Link'">
          <template v-slot:preview>
            <p><code>&lt;b-link&gt;</code> is the building block for most BootstrapVue components that offer link functionality.</p>
            <div>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Links' }]);
  }
};
</script>
