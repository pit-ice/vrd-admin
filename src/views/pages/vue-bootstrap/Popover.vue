  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Popover</b> The Popover feature, which provides a tooltip-like behavior, can be easily applied to any interactive element via the
        &lt;b-popover&gt; component or v-b-popover directive.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/popover" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Popover'">
          <template v-slot:preview>
            <div class="text-center my-3">
              <b-button class="mr-3" v-b-popover.hover.top="'I am popover directive content!'" title="Popover Title">
                Hover Me
              </b-button>
        ...
        <KTCodePreview>
          <template v-slot:title> <code>&lt;b-popover&gt;</code> Component basic usage </template>
          <template v-slot:preview>
            <b-container fluid>
              ...
              <b-row>
                ...
                <b-col md="6" class="py-4 text-center">
                  ...
                  <b-popover target="popover-3" triggers="hover focus">
                    ...
                    Embedding content
                    <span class="text-danger">using slots</span> affords you <em>greater <strong>control.</strong></em> and basic HTML support.
                  </b-popover>
                </b-col>
              </b-row>
            </b-container>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Variants and custom class'">
          <template v-slot:preview>
            <p>BootstrapVue's popovers support contextual color variants via our custom CSS, via the <code>variant</code> prop:</p>
        ...
        <KTCodePreview v-bind:title="'Programmatically show and hide popover'">
          <template v-slot:preview>
            <p>
              You can manually control the visibility of a popover via the syncable Boolean <code>show</code> prop. Setting it to
              <code>true</code> will show the popover, while setting it to <code>false</code> will hide the popover.
            </p>
            <div class="d-flex flex-column text-md-center">
              ...
              <div class="p-2">
                ...
                <b-popover :show.sync="show" target="popover-button-sync" title="Popover"> Hello <strong>World!</strong> </b-popover>
              </div>
            </div>
          </template>
          <template v-slot:html>
        ...
        <KTCodePreview v-bind:title="'Programmatic control'">
          <template v-slot:preview>
            <p>
              Programmatic control can also be affected by submitting '<code>enable</code>' and '<code>disable</code>' events to the popover by
              reference.
            </p>
            <div class="d-flex flex-column text-md-center">
              <div class="p-2">
              ...
              <b-popover ref="popover" target="popover-button-event" title="Popover"> Hello <strong>World!</strong> </b-popover>
            </div>
          </template>
          <template v-slot:html>
            {{ code5.html }}
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Notify' }, { title: 'Popover' }]);
  }
};
</script>
