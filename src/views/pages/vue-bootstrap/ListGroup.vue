  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>List group</b> List groups are a flexible and powerful component for displaying a series of content. List group items can be modified to
        support just about any content within. They can also be used as navigation via various props.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/list-group" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Disabled items'">
          <template v-slot:preview>
            <p>
              Set the <code>disabled</code> prop on a <code>&lt;b-list-group-item&gt;</code> to make it appear disabled (also works with actionalable
              items. see below).
            </p>
            <b-list-group>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Actionable list group items'">
          <template v-slot:preview>
            <p>
              Turn a <code>&lt;b-list-group-item&gt;</code> into an actionable link (<code>&lt;a href=&quot;...&quot;&gt;</code>) by specifying either
              an <code>href</code> prop or router-link <code>to</code> prop.
            </p>
            <b-list-group>
        ...
        <KTCodePreview v-bind:title="'With badges'">
          <template v-slot:preview>
            <p>
              Add <code>badges</code> to any list group item to show unread counts, activity, and more with the help of some
              <a href="http://getbootstrap.com/docs/4.0/utilities/flex/" target="_blank">utility classes</a>.
            </p>
            <b-list-group>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'List Group' }]);
  }
};
</script>
