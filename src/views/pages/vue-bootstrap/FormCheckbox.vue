  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Form Checkbox Inputs</b> For cross browser consistency, &lt;b-form-checkbox-group&gt; and &lt;b-form-checkbox&gt; use Bootstrap's custom
        checkbox input to replace the browser default checkbox input. It is built on top of semantic and accessible markup, so it is a solid
        replacement for the default checkbox input.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/form-checkbox" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
          ...
          <template v-slot:preview>
            <div>
              ...
              <b-form-group label="Using sub-components:">
                <b-form-checkbox-group id="checkbox-group-2" v-model="code2.selected2" name="flavour-2">
        ...
        <KTCodePreview v-bind:title="'Inline and stacked checkboxes'">
          <template v-slot:preview>
            <p>
              <code>&lt;b-form-checkbox-group&gt;</code> components render inline checkboxes by default, while
              <code>&lt;b-form-checkbox&gt;</code> renders block-level (stacked) checkboxes.
            </p>
            <div>
              <b-form-group label="Form-checkbox-group inline checkboxes (default)">
                <b-form-checkbox-group v-model="code3.selected1" :options="code3.options" name="flavour-1a"></b-form-checkbox-group>
              </b-form-group>

              <b-form-group label="Form-checkbox-group stacked checkboxes">
                <b-form-checkbox-group v-model="code3.selected2" :options="code3.options" name="flavour-2a" stacked></b-form-checkbox-group>
              </b-form-group>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Control sizing'">
          <template v-slot:preview>
            <p>
              Use the <code>size</code> prop to control the size of the checkbox. The default size is medium. Supported size values are
          ...
          <template v-slot:preview>
            <div>
              <b-form-group label="Button-group style checkboxes">
                <b-form-checkbox-group v-model="code5.selected1" :options="code5.options" name="buttons-1" buttons></b-form-checkbox-group>
              </b-form-group>
              ...
              <b-form-group label="Stacked (vertical) button-group style checkboxes">
                <b-form-checkbox-group v-model="code5.selected3" :options="code5.options" stacked buttons></b-form-checkbox-group>
              </b-form-group>
            </div>
          </template>
          <template v-slot:html>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Form Checkbox' }]);
  }
};
</script>
