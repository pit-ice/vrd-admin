  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Dropdowns</b> Dropdowns are toggleable, contextual overlays for displaying lists of links and actions in a dropdown menu format.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/dropdown" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Button content'">
          <template v-slot:preview>
            <p>
              You can customize the text of the dropdown button by using either the <code>text</code> prop (shown in previous examples), or use the
              <code>button-content</code> slot instead of the <code>text</code> prop. The <code>button-content</code> slot allows you to use basic
              HTML and icons in the button content.
            </p>
            <div>
              ...
              <b-dropdown>
                <template v-slot:button-content> Custom <strong>Content</strong> with <em>HTML</em> via Slot </template>
                <b-dropdown-item href="#">An item</b-dropdown-item>
                <b-dropdown-item href="#">Another item</b-dropdown-item>
              </b-dropdown>
            </div>
        ...
        <KTCodePreview v-bind:title="'Sizing'">
          <template v-slot:preview>
            <p>
              ...
              <code>sm</code> for small button(s), or <code>lg</code> for large button(s).
            </p>
            <div>
              <div>
        ...
        <KTCodePreview v-bind:title="'Drop right or left'">
          <template v-slot:preview>
            <p>
              ...
              <code>dropright</code> prop. Or, turn it into a drop-left menu by setting the <code>dropleft</code> right prop to true.
            </p>
            <div>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Dropdown' }]);
  }
};
</script>
