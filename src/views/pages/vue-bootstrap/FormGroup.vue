  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Form group</b> The &lt;b-form-group&gt; component is the easiest way to add some structure to forms. Its purpose is to pair form controls
        with a legend or label, and to provide help text and invalid/valid feedback text, as well as visual (color) contextual state feedback.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/form-group" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Horizontal layout'">
          <template v-slot:preview>
            <p>
              By default, the label appears above the input element(s), but you may optionally render horizontal (label to the left of the input) at
              the various standard Bootstrap breakpoints.
            </p>
            <div>
              <b-form-group
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Label size'">
          <template v-slot:preview>
            <p>
              You can control the label text size match the size of your form input(s) via the optional <code>label-size</code> prop. Values can be
              '<code>sm</code>' or '<code>lg</code>' for small or large label, respectively. Sizes work for both horizontal and non-horizontal form
              groups.
            </p>
            <div>
        ...
        <KTCodePreview v-bind:title="'Nested form groups'">
          <template v-slot:preview>
            <p>
              Feel free to nest <code>&lt;b-form-group&gt;</code> components to produce advanced form layouts and semantic grouping of related form
              controls:
            </p>
            <div>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Form Group' }]);
  }
};
</script>
