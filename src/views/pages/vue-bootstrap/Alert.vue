  ...
  <div>
    ...
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Alerts</b> Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/alert" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
        ...
        <KTCodePreview v-bind:title="'Alerts'">
          <template v-slot:preview>
            ...
            <div>
              ...
              <b-alert v-model="code1.showDismissibleAlert" variant="danger" dismissible>
                Dismissible Alert!
              ...
              >
                ...
                <b-progress variant="success" :max="code1.dismissSecs" :value="code1.dismissCountDown" height="4px"></b-progress>
                <template v-slot:dismiss>
                  <div class="alert-close">
                    <span aria-hidden="true"><i class="la la-close"></i></span>
                  </div>
              ...
              <b-button @click="code1.showDismissibleAlert = true" variant="info" class="m-1">
                Show dismissible alert ({{ code1.showDismissibleAlert ? 'visible' : 'hidden' }})
              </b-button>
            </div>
          </template>
        ...
        <KTCodePreview v-bind:title="'Fading alerts'">
          <template v-slot:preview>
            ...
            <div>
              ...
              <b-alert variant="danger" dismissible fade :show="code2.showDismissibleAlert" @dismissed="code2.showDismissibleAlert = false">
                Dismissible Alert!
                <template v-slot:dismiss>
                  <div class="alert-close">
                    <span aria-hidden="true"><i class="la la-close"></i></span>
              ...
              <b-alert :show="code2.dismissCountDown" dismissible fade variant="warning" @dismiss-count-down="countDownChanged2">
                This alert will dismiss after
              ...
              <b-button @click="code2.showDismissibleAlert = true" variant="info" class="m-1">
                Show dismissible alert ({{ code2.showDismissibleAlert ? 'visible' : 'hidden' }})
                <template v-slot:dismiss>
                  <div class="alert-close">
                    <span aria-hidden="true"><i class="la la-close"></i></span>
                  </div>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Contextual variants'">
          <template v-slot:preview>
            <p>
              For proper styling of &lt;b-alert&gt;, use one of the four required contextual variants by setting the variant prop to one of the
              following: <code>info</code>, <code>success</code>, <code>warning</code> or <code>danger</code>. The default is <code>info</code>.
            </p>
            <div>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Alert' }]);
  },
  methods: {
