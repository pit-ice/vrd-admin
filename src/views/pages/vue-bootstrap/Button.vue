  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Buttons</b> Use Bootstrap's custom b-button component for actions in forms, dialogs, and more. Includes support for a handful of contextual
        variations, sizes, states, and more.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/button" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Squared style'">
          <template v-slot:preview>
            ...
            <div>
              ...
              <b-button class="mr-3" squared variant="outline-secondary">Button</b-button>
              <b-button class="mr-3" squared variant="success">Button</b-button>
              <b-button class="mr-3" squared variant="outline-danger">Button</b-button>
        ...
        <KTCodePreview v-bind:title="'Pressed state and toggling'">
          <template v-slot:preview>
            <p>
              Buttons will appear pressed (with a darker background, darker border, and inset shadow) when the prop <code>pressed</code> is set to
              true.
            </p>
            <div>
              <h5>Pressed and un-pressed state</h5>
              <b-button class="mr-3" :pressed="true" variant="success">Always Pressed</b-button>
              <b-button class="mr-3" :pressed="false" variant="success">Not Pressed</b-button>

              <h5 class="mt-3">Toggleable Button</h5>
              <b-button class="mr-3" :pressed.sync="myToggle" variant="primary">Toggle Me</b-button>
              <p class="mt-3">
              ...
              <b-button-group size="sm">
                <b-button class="mr-3" v-for="(btn, idx) in buttons" :key="idx" :pressed.sync="btn.state" variant="primary">
                  {{ btn.caption }}
                </b-button>
              </b-button-group>
              <p class="mt-3">
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Buttons' }]);
  },
  computed: {
    btnStates() {
      return this.buttons.map(btn => btn.state);
