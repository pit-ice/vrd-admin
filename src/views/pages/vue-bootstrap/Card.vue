  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Cards</b> A card is a flexible and extensible content container. It includes options for headers and footers, a wide variety of content,
        contextual background colors, and powerful display options.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/card" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
      ...
      <div class="col-md-6">
        <KTCodePreview v-bind:title="'Cards'">
          <template v-slot:preview>
            <p>
              Cards are built with as little markup and styles as possible, but still manage to deliver a ton of control and customization. Built with
              flexbox, they offer easy alignment and mix well with other components.
            </p>
            <div>
              <b-card
                title="Card Title"
        ...
        <KTCodePreview v-bind:title="'Background variants'">
          <template v-slot:preview>
            <p>
              Cards include their own variant style for quickly changing the background-color and of a card via the <code>bg-variant</code> and
              <code>border-</code> props. Darker solid variants my require setting the prop <code>variant</code> to adjust the text color.
            </p>
            <div>
              <div>
                <b-card-group deck>
        ...
        <KTCodePreview v-bind:title="'Bordered variants'">
          <template v-slot:preview>
            <div>
              <div>
                <b-card-group deck>
                  <b-card border-variant="primary" header="Primary" header-bg-variant="primary" header-text-variant="white" align="center">
                    <b-card-text>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</b-card-text>
                  </b-card>
              ...
              <div class="mt-3">
                <b-card-group deck>
                  ...
                  <b-card border-variant="danger" header="Danger" header-border-variant="danger" header-text-variant="danger" align="center">
                    <b-card-text>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</b-card-text>
                  </b-card>
                </b-card-group>
              </div>
      ...
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Header and footer'">
          <template v-slot:preview>
            <div>
              <b-card-group deck>
                <b-card header="featured" header-tag="header" footer="Card Footer" footer-tag="footer" title="Title">
        ...
        <KTCodePreview v-bind:title="'Horizontal card layout'">
          <template v-slot:preview>
            <p>
              Using a combination of grid components, utility classes and individual card sub-components, cards can be made horizontal in a
...
<b-card-group deck>
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Card' }]);
  }
};
</script>
