  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Collapse</b> Easily toggle visibility of almost any content on your pages. Includes support for making accordions.
    ...
    <div class="row">
        ...
        <KTCodePreview v-bind:title="'Trigger multiple collapse elements'">
          <template v-slot:preview>
            <p>
              ...
              <code>&lt;b-collapse&gt;</code> components via a single <code>v-b-toggle</code> by providing multiple target IDs using modifiers:
            </p>
            <div>
      ...
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Initial visibility'">
          <template v-slot:preview>
            <p>To make the <code>&lt;b-collapse&gt;</code> show initially, set the <code>&lt;b-collapse&gt; visible</code> prop:<br /><br /></p>
            <div>
