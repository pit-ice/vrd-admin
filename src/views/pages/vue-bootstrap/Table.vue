  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Tables</b> For displaying tabular data, &lt;b-table&gt; supports pagination, filtering, sorting, custom rendering, various style options,
        events, and asynchronous data. For simple display of tabular data without all the fancy features, BootstrapVue provides two lightweight
        alternative components &lt;b-table-lite&gt; and &lt;b-table-simple&gt;.
        <a class="font-weight-bold" href="https://bootstrap-vue.js.org/docs/components/table" target="_blank">
          See documentation.
        </a>
      </div>
    </b-alert>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <KTCodePreview v-bind:title="'Using variants for table cells'">
          <template v-slot:preview>
            <p>
              Record data may also have additional special reserved name keys for colorizing rows and individual cells (variants), and for triggering
              additional row detail. The supported optional item record modifier properties (make sure your field keys do not conflict with these
              names):
            </p>
            <div>
        ...
        <KTCodePreview v-bind:title="'Fields as a simple array'">
          <template v-slot:preview>
            ...
            <div>
              <b-table striped hover :items="code3.items" :fields="code3.fields"></b-table>
            </div>
          </template>
          <template v-slot:html>
            {{ code3.html }}
        ...
        <KTCodePreview v-bind:title="'Fields as an array of objects'">
          <template v-slot:preview>
            <p>
              Fields can be a an array of objects, providing additional control over the fields (such as sorting, formatting, etc). Only columns
              (keys) that appear in the fields array will be shown:
            </p>
            <div>
              <b-table striped hover :items="code4.items" :fields="code4.fields"></b-table>
            </div>
          </template>
          <template v-slot:html>
            {{ code4.html }}
        ...
        <KTCodePreview v-bind:title="'Table style options'">
          <template v-slot:preview>
            <p>
              Table style options <code>fixed</code>, <code>stacked</code>, <code>caption-top</code>, <code>no-border-collapse</code>, sticky headers,
              sticky columns, and the table sorting feature, all require BootstrapVue's custom CSS.
            </p>
            <div>
              ...
              <b-form-group label="Table Variant" label-for="table-style-variant" label-cols-lg="2">
                <b-form-select v-model="code5.tableVariant" :options="code5.tableVariants" id="table-style-variant">
