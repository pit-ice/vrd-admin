  ...
  <div>
    <b-alert show variant="light" class="alert alert-custom alert-white alert-shadow fade show gutter-b">
      ...
      <div class="alert-text">
        <b>Input Groups</b> Easily extend form controls by adding text, buttons, or button groups on either side of textual inputs.
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <KTCodePreview v-bind:title="'Using sub-components'">
          <template v-slot:preview>
            <p>
              Use the <code>&lt;b-input-group-prepend&gt;</code> or <code>&lt;b-input-group-append&gt;</code> to add arbitrary addons wherever you
              like, and use these components to group buttons in your input group. Single buttons must always be wrapped in these components for
              proper styling.
            </p>
            <div>
              <b-input-group>
        ...
        <KTCodePreview v-bind:title="'Custom radio, checkbox, and switch addons'">
          <template v-slot:preview>
            <p>
              Using <code>&lt;b-form-checkbox&gt;</code> and <code>&lt;b-form-radio&gt;</code> components as addons, using Bootstrap
              <a href="https://bootstrap-vue.js.org/docs/reference/utility-classes" target="_blank">utility classes</a>
...
export default {
  ...
  mounted() {
    this.$store.dispatch(SET_BREADCRUMB, [{ title: 'Vue Bootstrap', route: 'alert' }, { title: 'Input Groups' }]);
  }
};
</script>
