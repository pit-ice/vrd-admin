    ...
    >
      ...
      <div class="menu-submenu">
        ...
        <ul class="menu-subnav">
          ...
          <router-link to="/vue-bootstrap/layout-grid-system" v-slot="{ href, navigate, isActive, isExactActive }">
            <li
              aria-haspopup="true"
              data-menu-toggle="hover"
              class="menu-item"
          ...
          <li aria-haspopup="true" data-menu-toggle="hover" class="menu-item menu-item-submenu">
            ...
            <div class="menu-submenu">
              ...
              <ul class="menu-subnav">
                ...
                <router-link to="/vue-bootstrap/popover" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
                ...
                <router-link to="/vue-bootstrap/toasts" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
                ...
                <router-link to="/vue-bootstrap/tooltip" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
          ...
          <li aria-haspopup="true" data-menu-toggle="hover" class="menu-item menu-item-submenu">
            ...
            <div class="menu-submenu">
              ...
              <ul class="menu-subnav">
                ...
                <router-link to="/vue-bootstrap/spinner" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
          ...
          <li aria-haspopup="true" data-menu-toggle="hover" class="menu-item menu-item-submenu">
            ...
            <div class="menu-submenu">
              ...
              <ul class="menu-subnav">
                ...
                <router-link to="/vuetify/autocompletes" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
                ...
                <router-link to="/vuetify/file-inputs" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
                ...
                <router-link to="/vuetify/selection-controls" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
                ...
                <router-link to="/vuetify/selects" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
                ...
                <router-link to="/vuetify/textareas" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
                ...
                <router-link to="/vuetify/text-fields" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
          ...
          <li aria-haspopup="true" data-menu-toggle="hover" class="menu-item menu-item-submenu">
            ...
            <div class="menu-submenu">
              ...
              <ul class="menu-subnav">
                ...
                <router-link to="/vuetify/simple-tables" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
                ...
                <router-link to="/vuetify/data-tables" v-slot="{ href, navigate, isActive, isExactActive }">
                  <li
                    aria-haspopup="true"
                    data-menu-toggle="hover"
                    class="menu-item"
